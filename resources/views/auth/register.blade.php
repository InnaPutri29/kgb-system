<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <div>
            ...
            <input id="name" class="block w-full rounded-xl border-slate-200 bg-slate-50/50 shadow-sm focus:bg-white focus:border-blue-500 focus:ring-blue-500 transition-colors text-sm px-4 py-2.5" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="Misal: Budi Santoso" />
        ...
        <div>
            ...
            <input id="nip" class="block w-full rounded-xl border-slate-200 bg-slate-50/50 shadow-sm focus:bg-white focus:border-blue-500 focus:ring-blue-500 transition-colors text-sm px-4 py-2.5" type="text" name="nip" :value="old('nip')" required autocomplete="username" placeholder="Masukkan 18 digit NIP" />
