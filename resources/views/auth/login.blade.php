    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-5">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input id="email" class="pl-10 block w-full rounded-xl border-white/40 bg-white/40 backdrop-blur-sm shadow-inner focus:bg-white/70 focus:border-blue-500 focus:ring-blue-500 transition-all duration-300 text-sm py-2.5 placeholder-slate-500 text-slate-800" type="text" name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="admin@kgb.com" />
            </div>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input id="password" class="pl-10 block w-full rounded-xl border-white/40 bg-white/40 backdrop-blur-sm shadow-inner focus:bg-white/70 focus:border-blue-500 focus:ring-blue-500 transition-all duration-300 text-sm py-2.5 placeholder-slate-500 text-slate-800"
                                type="password"
                                name="password"
