    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-5">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input id="email" class="pl-10 block w-full rounded-xl border-slate-200 bg-white shadow-[0_2px_10px_rgb(0,0,0,0.02)] focus:bg-white focus:border-blue-500 focus:ring-blue-500 transition-all duration-200 text-sm py-2.5" type="text" name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="admin@kgb.com" />
            </div>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input id="password" class="pl-10 block w-full rounded-xl border-slate-200 bg-white shadow-[0_2px_10px_rgb(0,0,0,0.02)] focus:bg-white focus:border-blue-500 focus:ring-blue-500 transition-all duration-200 text-sm py-2.5"
                                type="password"
                                name="password"
