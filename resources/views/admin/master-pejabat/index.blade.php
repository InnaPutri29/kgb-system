                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="{{ route('admin.master-pejabat.show', $p) }}" class="p-1.5 bg-gray-50 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-md transition" title="Detail Pejabat">
                                    ...
                                    <form action="{{ route('admin.master-pejabat.destroy', $p) }}" method="POST" class="inline-block" onsubmit="return confirm('Hapus pejabat {{ $p->nama_pejabat }}?')">
                                        @csrf @method('DELETE')
                                        <button type="submit" class="p-1.5 bg-gray-50 text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-md transition" title="Hapus Pejabat">
