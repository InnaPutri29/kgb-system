                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-3">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <form action="{{ route('admin.master-gaji.destroy', $g) }}" method="POST" class="inline-block" onsubmit="return confirm('Hapus acuan gaji Golongan {{ $g->golongan }} MKG {{ $g->masa_kerja }} Tahun?')">
                                        @csrf @method('DELETE')
                                        <button type="submit" class="p-1.5 bg-gray-50 text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-md transition" title="Hapus Gaji">
