                        ...
                        <tr class="hover:bg-white/40 transition">
                            ...
                            <td class="px-3 py-3 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('admin.kgb.show', $riwayat->id) }}" class="inline-flex justify-center items-center p-1.5 bg-gray-100 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-md transition" title="Detail Riwayat KGB">
